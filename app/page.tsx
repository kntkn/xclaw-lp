...
const agents = [
  {
    ...
    tagline:
      "採用よりも早く、コンサルよりも安く。戦略から実行まで一気通貫で動きます。",
  },
  {
    id: "warren",
    emoji: "📊",
    ...
    tagline:
      "数字で語る。POCのKPIから撤退基準まで、根拠ある判断を支えます。",
  },
  {
    id: "jobs",
    emoji: "🛠️",
    ...
    tagline:
      '"なぜ作るか"を問い続ける。作りすぎない、無駄を削ぎ落としたプロダクト設計。',
  },
  {
    id: "aika",
    emoji: "📣",
    ...
    tagline:
      "市場の流れを読み、刺さるメッセージを届ける。スピードと精度を両立。",
  },
  {
    id: "elon",
    emoji: "⚡",
    ...
    tagline: "実行が全て。計画を動かし、止まったものを再起動する。",
  },
];
