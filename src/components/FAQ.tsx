...
const faqs = [
  {
    ...
    a: "コミュニティ参加権、オンボーディング、ノード構築ガイド、定期セッション、AIエージェント稼働支援が含まれます。ハードウェアは別途です。",
  },
  {
    q: "Mac miniは必要ですか？",
    a: "推奨ですが、参加時点で必須ではありません。オンボーディングで導入ガイダンスを提供します。",
  },
  {
    q: "エンジニアでなくても参加できますか？",
    a: "参加できます。ガイドに沿ってセットアップでき、コミュニティ内で段階的にスキルを習得できます。",
  },
  {
    q: "顧客データの安全性は？",
